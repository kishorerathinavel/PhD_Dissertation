...
%\definecolor{Fuchsia}{rgb}{1.00,0.47,1.00}

\newcommand{\lookup}[1]{\textcolor{Blue}{[Lookup: #1]}}
\newcommand{\myverbatim}[1]{\textcolor{Fuchsia}{[Verbatim: #1]}}
\newcommand{\todo}[1]{\textcolor{Red}{[To do: #1]}}
\newcommand{\doubt}[1]{\textcolor{Red}{[Doubt: #1]}}
\newcommand{\answer}[1]{\textcolor{DarkGreen}{[Answer: #1]}}
\newcommand{\openproblem}[1]{\textcolor{DarkGreen}{[Open Problem: #1]}}
\newcommand{\opinion}[1]{\textcolor{Purple}{[Opinion: #1]}}
\newcommand{\citedsectionheading}[2]{\section[#1]{#1 #2}}

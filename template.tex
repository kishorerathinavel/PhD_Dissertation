\documentclass[letterpaper,11pt,twoside]{uncthesis}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Modifications specific to Kishore's dissertation. BEGIN.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\newcommand\myblockquote[2]{%
  \blockquote{\hspace*{4em}\emph{`#1'}\hfill#2}\par}

\DeclareMathOperator*{\argmin}{arg\!\min}
\DeclareMathOperator*{\argmax}{arg\!\max}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Modifications specific to Kishore's dissertation. END.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% Title
\uncthesistitle{Volumetric and Varifocal-occlusion augmented reality displays}

% Name
\uncthesisauthor{Kishore Rathinavel}
...
\uncthesiscommittee{Henry Fuchs\\
David Luebke\\
Leonard McMillan\\
Montek Singh\\
Gordon Wetzstein\\
...
% 1. Title Page
\input{frontmatter/1_titlepage}

% 2. Copyright Page (optional)
\input{frontmatter/2_copyright}

% 3. Abstract
\input{frontmatter/3_abstract}
...
\input{frontmatter/6_lot}
\input{frontmatter/6_lof}

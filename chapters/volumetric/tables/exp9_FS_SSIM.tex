...
\end{tabular}}
\end{center}
\caption[Volumetric NED: Adaptive decomposition results: SSIM values of focal stacks for transparent objects and $N_{\text{planes}}=25$]{Table shows SSIM values for focal stacks of the different algorithms. This table is for the cards target image and 25 binary depth planes.}

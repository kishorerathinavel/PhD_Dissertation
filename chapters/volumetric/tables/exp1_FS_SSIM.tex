...
\end{tabular}}
\end{center}
\caption[Volumetric NED: Adaptive decomposition results: SSIM values of focal stacks for opaque objects and $N_{\text{planes}}=280$]{Table shows Structural Similarity Index (SSIM) values for focal stacks of the different algorithms. This table is for the cards target image and 280 binary depth planes.}

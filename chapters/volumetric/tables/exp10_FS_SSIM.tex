...
\end{tabular}}
\end{center}
\caption[Volumetric NED: Adaptive decomposition results: SSIM values of focal stacks for transparent objects and $N_{\text{planes}}=280$]{Table shows SSIM values for focal stacks of the different algorithms. This table is a virtual scene composed of transparent objects and 280 binary depth planes.}
